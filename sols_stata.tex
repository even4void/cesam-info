...
\label{start:sol2stata}
\soln{\ref{exo:9.1}} On rappelle que seules les valeurs numériques des poids
...
\includegraphics{./figs/stata_sirds_r}
...
\includegraphics{./figs/stata_student_r}
...
\includegraphics{./figs/stata_infarctus_r}
% FIXME:
% display as percent
...
\includegraphics{./figs/stata_infarctus2_r}
...
\includegraphics{./figs/stata_polymsm_r}
...
\includegraphics{./figs/stata_sck_r}
...
\includegraphics{./figs/stata_sck2_r}
...
\includegraphics{./figs/stata_sck3_r}
...
\includegraphics{./figs/stata_stsgraph_rx}

En ce qui concerne le test du log-rank, il faut utiliser la commande
...
Enfin, pour réaliser un modèle de régression de Cox, avec stratification sur
