...
/* Exercice 8.5 */
DATA elderly;
INFILE  "C:\MESBAH\D\MESBAH\Enseignements\ISUP\CESAM\PROJETS\R\CESAM_R\data\elderly.dat" dlm="09"X ;
INPUT  taille @@ ;
RUN;
...
PROC IMPORT OUT= WORK.BIRTHWT
            DATAFILE= "C:\MESBAH\D\MESBAH\Enseignements\ISUP\CESAM\PROJETS\R\CESAM_R\data\birthwt.dat"
            DBMS=DLM REPLACE;
     DELIMITER='20'x;
     GETNAMES=NO;
     DATAROW=1;
