...
\vskip3em
\centerline{\LARGE Année Universitaire 2013–2014}
\vfill
\begin{center}
...
\hline
  Sem. 05/11 & Éléments du langage, gestion de données & Cours 1 & Corrigés
  pp.~\pageref{start:sol1}–\pageref{stop:sol1} & \\
  Sem. 12/11 & Statistiques descriptives et estimation & Cours 2 & Corrigés
  pp.~\pageref{start:sol2}–\pageref{stop:sol2} & Devoir \no 1\\
  Sem. 19/11 & Comparaisons de deux variables & Cours 3 & Corrigés
  pp.~\pageref{start:sol3}–\pageref{stop:sol3} & Devoir \no 2\\
  Sem. 26/11 & Analyse de variance et plans d'expérience & Cours 4 &
  Corrigés pp.~\pageref{start:sol4}–\pageref{stop:sol4} & Devoir \no 3\\
  Sem. 03/12 & Corrélation et régression linéaire & Cours 5 & Corrigés
  pp.~\pageref{start:sol5}–\pageref{stop:sol5} & Devoir \no 4\\
  Sem. 10/12 & Mesures d'association en épidémiologie et régression
  logistique & Cours 6 & Corrigés
  pp.~\pageref{start:sol6}–\pageref{stop:sol6} & Devoir \no 5\\
  Sem. 17/12 & Données de survie & Cours 7 & Corrigés
...
histogram(~ bwt, data=birthwt, type="percent", xlab="Poids des bébés (g)")
@
...
\hline
  Sem. 07/01 & Élements du langage et statistiques descriptives & Corrigés
  pp.~\pageref{start:sol8b}–\pageref{stop:sol8b} & Devoir
  \no 7\\
  Sem. 14/01 & Mesures d'association et comparaison de deux variables &
  Corrigés pp.~\pageref{start:sol9b}–\pageref{stop:sol9b} &
  Devoir \no 8\\
  Sem. 21/01 & Régression linéaire et logistique & Corrigés pp.~\pageref{start:sol10b}–\pageref{stop:sol10b} & Devoir \no 9\\
  Sem. 28/01 & Données de survie & Corrigés pp.~\pageref{start:sol11b}–\pageref{stop:sol11b} & Devoir \no 10\\
\hline
\end{tabular}
\end{center}
