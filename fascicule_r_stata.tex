...
\vskip3em
\centerline{\LARGE Année Universitaire 2014–2015}
\vfill
\begin{center}
...
\hline
  Sem. 23/02 & Éléments du langage, gestion de données & Cours 1 & Corrigés
  pp.~\pageref{start:sol1}–\pageref{stop:sol1} & \\
  Sem. 02/03 & Statistiques descriptives et estimation & Cours 2 & Corrigés
  pp.~\pageref{start:sol2}–\pageref{stop:sol2} & Devoir \no 1\\
  Sem. 09/03 & Comparaisons de deux variables & Cours 3 & Corrigés
  pp.~\pageref{start:sol3}–\pageref{stop:sol3} & Devoir \no 2\\
  Sem. 16/03 & Analyse de variance et plans d'expérience & Cours 4 &
  Corrigés pp.~\pageref{start:sol4}–\pageref{stop:sol4} & Devoir \no 3\\
  Sem. 23/03 & Corrélation et régression linéaire & Cours 5 & Corrigés
  pp.~\pageref{start:sol5}–\pageref{stop:sol5} & Devoir \no 4\\
  Sem. 30/03 & Mesures d'association en épidémiologie et régression
  logistique & Cours 6 & Corrigés
  pp.~\pageref{start:sol6}–\pageref{stop:sol6} & Devoir \no 5\\
  Sem. 06/04 & Données de survie & Cours 7 & Corrigés
